...
class YOLODetector(BaseDetector):
    ...
    def images_detection(self, imgs, orig_dim_list):
        ...
        with torch.no_grad():
            ...
            # todo: 下面这个就是把多个种类归成一个person种类的关键函数吗，prediction是很多的东西，dets就剩下很少了；这里传了一个很关键的叫num_classes=80
            # 返回的dets的格式是4x8，据网上说法这8个属性分别是：检测所属的批次中的图像索引，4个角坐标，客观分数，具有最大置信度的类别的分数以及该类别的索引。
